...
export const SearchView: React.FC<SearchViewProps> = ({ onOpenSettings }) => {
  ...
  return (
    <div>
      <div className="flex items-center p-3 space-x-3 border-b border-gray-200 dark:border-gray-700">
        ...
        <button 
          ...
          className="p-2 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-700 flex-shrink-0"
          title="Settings"
        >
